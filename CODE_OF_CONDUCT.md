...
This Code of Conduct applies within all project spaces, including the repository, issue tracker, discussions, and any other forums created by the project team. It also applies when an individual is representing the project in public spaces.
